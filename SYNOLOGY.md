...
```bash
# Сделайте скрипт исполняемым (только при первом использовании)
chmod +x scripts/update-synology.sh

# Запустите скрипт обновления
sudo ./scripts/update-synology.sh
```

Скрипт автоматически:
1. Обновит код через `git pull`
